                ...
                <div class="content-inner">
                    <header class="page-header">
                        <div class="container-fluid">
                            <h2 class="no-margin-bottom">Alterar Cliente</h2>
                        </div>
                    </header><%
                    try{
                        if (request.getParameter("cpf")!=null){
                            Cliente c = Bd.getClientes().get(request.getParameter("cpf"));
                                    ...
                                    <div class="row">
                                        <div class="chart col-lg-12 col-12">
                                            <div class="bg-white align-items-center justify-content-center has-shadow format-box-forms">
                                                <form method="post" name="login-form" action="clientes.jsp">
                                                    ...
                                                    <div class="row">
                                                        <div id="tipo_cad" class="col-sm-12 format-box-forms-ini">
                                                            ...
                                                            <div class="col-sm-8 format-box-forms-ini">
                                                                <div class="form-group-material">
                                                                    <input id="rg" maxlength="11" type="text" name="rg" value="<%=rg%>" class="input-material" required />
